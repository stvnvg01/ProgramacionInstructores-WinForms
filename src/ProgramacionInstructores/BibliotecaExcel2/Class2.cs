...
namespace BibliotecaExcel2
{
    public class Class2
    {
        ...
        try
        {
            ...
            string[] horas = {
                      "06:00 am - 08:00 am", "08:00 am - 10:00 am", "10:00 am - 12:00 pm", "12:00 pm - 02:00 pm",
            ...
            sheet.Cells[21, 2] = "HORAS DIARIAS:";
            sheet.Cells[22, 2] = "HORAS SEMANALES:";
            sheet.Cells[23, 2] = "HORAS MENSUALES:";
            ...
            for (int i = 0; i < 38; i++) // C a AG son 31 columnas
            {
                ...
                string formula = $"=SUMA({colLetra}13:{colLetra}20)";
                sheet.Range[$"{colLetra}21"].FormulaLocal = formula;

                // Opcional: formato
                sheet.Range[$"{colLetra}21"].Font.Bold = true;
                sheet.Range[$"{colLetra}21"].HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
            }
            //J28-P28, Q28-W28, X28-AD28, AE20-AG28
            Excel.Range SUMSEM1 = sheet.Range["C22", "I22"];
            SUMSEM1.Merge(); // Fusionar celdas
            SUMSEM1.FormulaLocal = "=SUMA(C21:I21)";
            SUMSEM1.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            Excel.Range SUMSEM2 = sheet.Range["J22", "P22"];
            SUMSEM2.Merge(); // Fusionar celdas
            SUMSEM2.FormulaLocal = "=SUMA(J21:P21)";
            SUMSEM2.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            Excel.Range SUMSEM3 = sheet.Range["Q22", "W22"];
            SUMSEM3.Merge(); // Fusionar celdas
            SUMSEM3.FormulaLocal = "=SUMA(Q21:W21)";
            SUMSEM3.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            Excel.Range SUMSEM4 = sheet.Range["X22", "AD22"];
            SUMSEM4.Merge(); // Fusionar celdas
            SUMSEM4.FormulaLocal = "=SUMA(X21:AD21)";
            SUMSEM4.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            Excel.Range SUMSEM5 = sheet.Range["AE22", "AK22"];
            SUMSEM5.Merge(); // Fusionar celdas
            SUMSEM5.FormulaLocal = "=SUMA(AE21:AK21)";
            SUMSEM5.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            Excel.Range SUMSEM6 = sheet.Range["AL22", "AN22"];
            SUMSEM6.Merge(); // Fusionar celdas
            SUMSEM6.FormulaLocal = "=SUMA(AL21:AN21)";
            SUMSEM6.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            Excel.Range SUMMES1 = sheet.Range["C23", "AN23"];
            SUMMES1.Merge(); // Fusionar celdas
            SUMMES1.FormulaLocal = "=SUMA(C21:AN21)";
            ...
            for (int i = 0; i < dgvCronograma.Rows.Count; i++)
            {
                for (int j = 1; j < dgvCronograma.Columns.Count; j++)  // Saltamos la columna de horas
                {
                    ...
                    excelCelda.Value = (celdaDataGrid.Style.BackColor != Color.White && celdaDataGrid.Style.BackColor != Color.LightGray) ? "2" : "";
            ...
            string[] rangos = {
                    "C10:I12", "C13:I20", "C21:I21", "B9:B20",
                    "C11:AN12", "C10:AN10", "J10:P12", "Q10:W12",
                    "X10:AD12", "AE10:AN12", "J13:P20", "Q13:W20",
                    "X13:AD20", "AE13:AN20", "J21:P21", "Q21:W21",
                    "X21:AD21", "AE21:AN21", "C22:P22", "J22:W22",
                    "Q22:AD22", "X22:AN22", "B21:B23", "B21:B22",
                    "B22:B23", "B23:AN23", "B9:AN12", "AL10:AN20",
                    "X21:AK21", "X22:AK22"
                };
